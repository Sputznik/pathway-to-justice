...
<div class="container">
  <div class="row">
    <div class="col-sm-8">
      ...
      <ul id="archive-resources" data-target="<?php _e('li.orbit-article');?>" data-url="" class="list-unstyled list-articles">
        <?php while( have_posts() ) : the_post();?>
          <?php get_template_part( "partials/content", "archive" );?>
        <?php endwhile;?>
      </ul>
      <div class='orbit-btn-load-parent text-center'>
      	<button data-behaviour='oq-ajax-loading' data-list="#archive-resources" class="load-more" type="button">
